...
@Component({
  selector: 'app-trend-engineer-report',
  templateUrl: './trend-engineer-report.component.html',
  styleUrls: ['./trend-engineer-report.component.css']
})
export class TrendEngineerReportComponent implements OnInit {
